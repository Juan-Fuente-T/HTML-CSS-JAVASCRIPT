...
class Combate{
   ...
   constructor(miPokemon, oponentePokemon, viewerHtmlMiPokemon, viewerHtmlOponentePokemon){
    ...
    establecerSalud(){
        ...
        let principal = this.viewerHtmlMiPokemon.getElementsByClassName("contenedor-barra-vida")[0];
        let miBarraVida = principal.getElementsByClassName("barra-vida")[0];
        let hpBarraVida = principal.getElementsByClassName("hp-barra-vida")[0];
        miBarraVida.innerHTML = '';
        miBarraVida.style.width = `${(this.miPokemon.salud / this.miPokemon.saludBase) * 100}%`;
        hpBarraVida.innerHTML = `${this.miPokemon.salud}/${this.miPokemon.saludBase}`;
        
        let principalOponente = this.viewerHtmlOponentePokemon.getElementsByClassName("contenedor-oponente-barra-vida")[0];
        let oponenteBarraVida = principalOponente.getElementsByClassName("barra-vida")[0];
        let hpOponenteBarraVida = principalOponente.getElementsByClassName("hp-barra-vida")[0];
        oponenteBarraVida.innerHTML = '';
        oponenteBarraVida.style.width = `${(this.oponentePokemon.salud / this.oponentePokemon.saludBase) * 100}%`;
        hpOponenteBarraVida.innerHTML = `${this.oponentePokemon.salud}/${this.oponentePokemon.saludBase}`;
